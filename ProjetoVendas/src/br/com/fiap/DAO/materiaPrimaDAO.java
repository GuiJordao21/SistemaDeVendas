...
public class materiaPrimaDAO {
	...
	public String Gravar(materiaPrima obj, Connection con)throws Exception{
	...
	public String apagar(int num, Connection con)throws Exception {
	...
	public String atualizarMatP(int n, materiaPrima obj, Connection con)throws Exception{
	...
	public materiaPrima pesquisa(int n, Connection con) throws Exception{
	...
	public List<materiaPrima> listaMat(Connection con)throws Exception{
