...
public class EnderecoDAO {
	...
	public String novoEndereco(EnderecoBeans e, Connection con) throws SQLException{
		...
		stmt=con.prepareStatement("INSERT INTO T_SPG_ESTOQUE_END VALUES (?,?,?)");
		stmt.setString(1, e.getCep());
		stmt.setInt(2, e.getNumero());
		stmt.setString(3, e.getComplemento());
		
		return "Endereço do estoque cadastrado com sucesso";		
	}//fim do método para cadastrar endereço do estoque
	...
	public String novoEndereco(String email, int cdf, EnderecoBeans e, Connection con) throws SQLException{
		...
		stmt=con.prepareStatement("INSERT INTO T_SPG_FORNECEDOR_END VALUES (?,?,?,?)");
		stmt.setInt(1, cdf);
		stmt.setString(2, e.getCep());
		stmt.setInt(3, e.getNumero());
		stmt.setString(4, e.getComplemento());
		
		return "Endereço do fornecedor cadastrado com sucesso";		
	}//fim do fornecedor
}
